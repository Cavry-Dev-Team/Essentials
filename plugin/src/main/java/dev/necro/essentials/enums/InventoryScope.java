package dev.necro.essentials.enums;
        ...
        switch (uppercaseInput) {
            ...
            default: {
                ...
                if (uppercaseInput.contains(":")) {
                    item = NecroEssentials.getInstance().getVersionSupport().getItemByName(uppercaseInput.split(":")[0], 1, Integer.parseInt(uppercaseInput.split(":")[1]));
                } else {
                    item = NecroEssentials.getInstance().getVersionSupport().getItemByName(uppercaseInput, 1, 0);
                }
