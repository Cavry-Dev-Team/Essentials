...
import dev.necro.essentials.managers.whitelist.WhitelistData;
...
public class WhitelistCommand extends CommandClass {
    ...
    @CommandDescription("Gets the information about the current NecroEssentials whitelist system configuration")
    ...
    @CommandDescription("Adds a player to the NecroEssentials whitelist system")
    public void addCommand(
        ...
        targets.forEach(target -> {
            ...
            if (plugin.getWhitelistManager().getWhitelistedList().contains(data)) {
                ...
                sender.sendMessage(plugin.getMainConfigManager().getPrefix() + "§eAdded §b" + data.getName() + " §eto the whitelist.");
            }
        });
    ...
    @CommandDescription("Removes a player to the NecroEssentials whitelist system")
    public void removeCommand(
        ...
        targets.forEach(target -> {
            ...
            if (plugin.getWhitelistManager().getWhitelistedList().contains(data)) {
                ...
                sender.sendMessage(plugin.getMainConfigManager().getPrefix() + "§eRemoved §b" + data.getName() + " §efrom the whitelist.");
            } else {
    ...
    @CommandDescription("Checks if a player is whitelisted in the NecroEssentials whitelist system")
    public void checkCommand(
        ...
        targets.forEach(target -> {
            ...
            if (whitelsited) {
                sender.sendMessage(plugin.getMainConfigManager().getPrefix() + "§b" + target.getName() + " §eis §awhitelisted.");
            } else {
                sender.sendMessage(plugin.getMainConfigManager().getPrefix() + "§b" + target.getName() + " §eis §cnot whitelisted.");
            }
        });
    }

    @CommandMethod("whitelist|ewl|wl toggle [toggle]")
    @CommandDescription("Toggles on or off the NecroEssentials whitelist system")
    ...
    @CommandDescription("Toggles on the NecroEssentials whitelist system")
    ...
    @CommandDescription("Toggles off the NecroEssentials whitelist system")
    ...
    @CommandDescription("Reloads the NecroEssentials whitelist system")
