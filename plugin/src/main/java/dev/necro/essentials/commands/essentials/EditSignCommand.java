...
public class EditSignCommand extends CommandClass {
    ...
    public void setCommand(
        ...
        sign.update();
        sender.sendMessage(plugin.getMainConfigManager().getPrefix() + "§eLine §b" + line + " §eupdated.");
    }
    ...
    public void clearCommand(
        ...
        if (line == -1) {
            ...
            sign.setLine(line, "");
            sign.update();
            sender.sendMessage(plugin.getMainConfigManager().getPrefix() + "§eLine §b" + line + " §ecleared.");
        }
    }
